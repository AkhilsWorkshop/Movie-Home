        ...
        <div>
            <div className="flex">
                <ReactPaginate
                    ...
                    activeClassName="rounded border-0 bg-blue-600 outline-none transition-all duration-300 rounded text-white hover:text-white hover:bg-white shadow-md focus:shadow-md"
