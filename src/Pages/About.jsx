        ...
        <>
            {
                loading ?
                    ...
                    <div className="h-[calc(100vh_-_7.5rem)] flex flex-col bg-gradient-to-bl from-[#141E30] via-[#1D4350] to-[#A43931]">

                        <div className="flex flex-col items-center justify-center h-full p-5 lg:px-72 gap-5 text-white">

                            <div className="bg-black bg-opacity-30 p-5 rounded-md flex flex-col items-center gap-5 shadow-2xl shadow-black/60">
                                ...
                                <div className="rounded-md flex flex-col gap-5">
                                    ...
                                    <ol className="flex flex-col gap-3">
                                        <li className="flex gap-2 items-center">
                                            <HiChevronDoubleRight size={15} className="text-yellow-400 shrink-0" />
